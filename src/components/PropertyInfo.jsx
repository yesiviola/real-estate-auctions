    ...
    return (
        <section className={styles.propertyInfo}>
            ...
            <div className={styles.buttons}>
                <button onClick={handleRequestClick} className={styles.requestButton}>Request A Visit / Information</button>
                <button onClick={handleRequestClick} className={styles.videoButton}>Live Walkthrough</button>
            </div>
            ...
            <div className={styles.auctioneer} onClick={handleAuctioneerClick}>
                <p><span role="img" aria-label="auctioneer">🔊</span> Auctioneer</p>
            </div>
            <div className={styles.bidInfo}>
                <div>
                    <p>Guide Price: <span className={styles.price}>$700,000.00</span></p>
                </div>
                <div>
                ...
                <div className={styles.bidInput}>
                    ...
                    <button onClick={handleParticipateClick} className={styles.participateButton}>Participate In Auction</button>
                </div>
            </div>
        </section>
    );
